...
| [033](ISSUE-033-loss-care-mode.md) | ロスケアモード（Phase 3）をステータス変更で解放する | 🟠 high | done |
...
| [051](ISSUE-051-monthly-ai-letter.md) | 月次AIメモリーレターをSora+機能として実装する | 🟠 high | done |
...
| [075](ISSUE-075-chat-header-copy.md) | チャット「{pet.name}へ」ヘッダーコピーのペット語りかけ誤認を修正する | 🔴 critical | open |
| [076](ISSUE-076-chat-session-safety.md) | チャット長時間セッションに休憩提案メッセージを挿入する | 🔴 critical | open |
...
| [079](ISSUE-079-chat-subtitle-copy.md) | チャットサブタイトル「いつでもそばにいるよ」をAI依存を助長しない表現に改める | 🔴 critical | open |
