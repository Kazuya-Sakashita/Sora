    ...
    <div className="min-h-screen pb-safe">
      ...
      <main className="px-6 space-y-4 pb-8">
        ...
        <button
          ...
          className="w-full h-12 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/50 flex items-center justify-center gap-2 text-sm text-muted-foreground hover:bg-white/80 transition-colors"
        >
          <Heart size={16} />
          気持ちを記録する
        </button>
